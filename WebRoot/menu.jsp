								...
								<TR>
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="<c:url value='/jsp/customer/add.jsp'/>" 
														target=main>－ 新增客户</A></TD>
												</TR>
												<TR> 
																<!-- <c:url value="/CustomerAction_list"/> 
																${pageContext.request.contextPath}-->
													<TD class=menuSmall><A class=style2 href="<c:url value='/CustomerAction_list'/>"
								...
								<TR>
									<TD>
										<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/CustomerAction_getIndustryCount?countMsg=industry"
														target=main>－客户行业统计</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/CustomerAction_getSourceCount?countMsg=source"
