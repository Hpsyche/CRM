...
<script type="text/javascript">
	function changeVerifyCodeImage(){
		var path="${pageContext.request.contextPath }/UserAction_generateVerifyCode?"+new Date().getTime();
		$("#verifyCodeImage").attr("src",path);
	};
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px">
                	<INPUT id=txtcode style="WIDTH: 130px" name="user_name">
                </TD>
              ...
              <TR>
                <TD style="HEIGHT: 28px"></TD>
                <TD style="HEIGHT: 28px">
                	<img id="verifyCodeImage" alt="验证码" src="${pageContext.request.contextPath }/UserAction_generateVerifyCode" height="28px">
              		<a href="javaScript:void(0)" onclick="changeVerifyCodeImage()"><font color="white">看不清，换一张</font></a>
                </TD>
                <TD style="HEIGHT: 28px">&nbsp;</TD>
              </TR>
              <TR>
              ...
              <TR>
                <TD><font color="red" ><s:property value="#error_msg" /> </font></TD>
                <TD><INPUT id=btn 
