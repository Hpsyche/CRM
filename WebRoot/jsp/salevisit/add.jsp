...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/SaleVisitAction_addOrUpdate"
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<input type="text" readonly="readonly" style="WIDTH: 180px" id="cust_name" value="<s:property value="#saleVisit.customer.cust_name" />"/>
