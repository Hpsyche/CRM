...
<SCRIPT language=javascript>
	...
	function deleteConfirm(name,path){
		var flag=window.confirm("您确定要删除本条拜访“"+name+"”的记录？");
		if(true==flag){
			$.post(path);
											...
											<TBODY>
												<TR>
													...
													<TD>
														...
														<INPUT class=textbox style="WIDTH: 80px" maxLength=50 name="cust_name"  id="cust_name" readonly="readonly" value="${param['cust_name']}" >
											...
											<TBODY>
												...
												<TR
													...
													<TD>
														...
														&nbsp;&nbsp;
														<a href="javascript:void(0)" onclick="deleteConfirm('<s:property value="customer.cust_name" />','${pageContext.request.contextPath }/SaleVisitAction_delete?visit_id=<s:property value="visit_id" />');" >删除</a>
													</TD>
												</TR>
												</s:iterator>
